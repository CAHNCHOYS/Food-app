<template>
  <article class="cart-product">
    <div class="cart-product__row" :class="{ op: isActionLoading }">
      <LoadingGif
        class="cart-product__delition-loading"
      ...
      <div class="cart-product__info">
        <div class="cart-product__name">
          <RouterLink :to="`/Products/${product.name}/${product.product_id}`">
        ...
        <div class="cart-product__actions">
          <div class="cart-product__count count-product">
            <div class="count-product__row count-product__row_small">
              <div
                class="count-product__action count-product__action_small count-product__action_minus"
                @click="decrementCount"
              ></div>
              <div class="count-product__number count-product__number_small">
                {{ product.count }}
              </div>
              <div
                class="count-product__action count-product__action_small icon-plus"
                @click="incrementCount"
              ></div>
            </div>
          </div>
          <div class="cart-product__total-price">{{ getFullPrice }}₽</div>
        </div>
