<template>
    <div class="checkout-details">
        <div class="checkout-details__all-deatils">
            ...
            <div class="checkout-details__detail-row">
                <div class="checkout-details__detail-text checkout-details__detail-text_res">Итого</div>
                <div class="checkout-details__detail-value checkout-details__detail-value_res">
                    {{ getTotalPrice }}₽
                </div>
...
const getTotalPrice = computed(() => {
    ...
    if (productsPrice >= 7000) {
        ...
        return userCartStore.isPromoActive ? (productsPrice + 200 - 100) : (productsPrice + 200);
    }
