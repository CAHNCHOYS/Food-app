<template>
   ...
   <div class="user-cart">
      ...
      <div class="user-cart__body" v-if="userAuthStore.checkIfUserLogged">
         <VErrorMessage v-if="userCartStore.isCartProductsErr" :err-message="userCartStore.loadErrorMessage">
         </VErrorMessage>

         <div class="user-cart__empty-cart empty-cart" v-else-if="
         ...
         <div class="user-cart__all-items" v-else="userCartStore.cartItems.length">
            ...
            <div class="user-cart__cart-items">
               ...
               <TransitionGroup name="list">
                  <div class="user-cart__cart-item" v-for="product in userCartStore.cartItems"
                     :key="product.product_id">
                     <UserCartProduct :product="product"></UserCartProduct>
                  </div>
               </TransitionGroup>
            ...
            <div class="user-cart__total" v-if="!isCheckoutPage">
               <div class="user-cart__price black-text">{{ userCartStore.getAllProductsPrice }}₽</div>
...
watch(() => userCartStore.cartItems.length, (newValue, oldValue) => {
