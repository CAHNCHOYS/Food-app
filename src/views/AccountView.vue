   ...
   <div class="user-account">
      ...
      <div class="user-account__body" v-if="userAuthStore.currentUser">
         ...
         <div class="user-account__info" v-show="!isUserEditing">
            <div class="user-account__all-info">
               <div class="user-account__info-block">
                  ...
                  <div class="user-account__info-value">{{ userAuthStore.currentUser.name }}</div>

               </div>
               <div class="user-account__info-block">
                  <div class="user-account__info-text">email: </div>
                  <div class="user-account__info-value">{{ userAuthStore.currentUser.email }}</div>

               </div>
               <div class="user-account__info-block">
                  <div class="user-account__info-text">Телефон: </div>
                  <div class="user-account__info-value">{{ userAuthStore.currentUser.phone }}</div>
         ...
         <div class="user-account__edit" v-show="isUserEditing">
            <vForm @submit="formSubmit" class="user-account__edit-form edit-form" :validation-schema="userEditSchema"
               :initial-values="initialValues">
               <div class="edit-form__elements">
                  <div class="edit-form__element">
                     <div class="edit-form__element-title">Ваш эмайл</div>
                     <vField name="email" type="text" class="edit-form__element-input"></vField>
                     <ErrorMessage name="email" class="edit-form__wrong-data"></ErrorMessage>
                  </div>
                  <div class="edit-form__element">
                     <div class="edit-form__element-title">Имя</div>
                     <vField name="name" type="text" class="edit-form__element-input"></vField>
                     <ErrorMessage name="name" class="edit-form__wrong-data"></ErrorMessage>
                  </div>

                  <div class="edit-form__element">
                     <div class="edit-form__element-title">Телефон</div>
                     <vField name="phone" type="text" class="edit-form__element-input"></vField>
                     <ErrorMessage name="phone" class="edit-form__wrong-data"></ErrorMessage>
                  </div>

                  <div class="edit-form__element" v-show="isUserEditing">
                     <button :disabled="isLoading" type="submit" class="user-account__btn user-account__btn_update"
                  ...
                  <LoadingGif v-if="isLoading" class="edit-form__loading"> </LoadingGif>
                  <VErrorMessage :error-message="`Ошибка при обновлении информации`" v-if="isError"> </VErrorMessage>
         ...
         <div class="user-account__actions">
            ...
            <button class="user-account__btn user-account__btn_edit" @click="isUserEditing = !isUserEditing">
               <span v-show="!isUserEditing">Изменить данные </span> <span v-show="isUserEditing"> Отменить изменение
               </span>
            </button>
...
const updateErrorMessage = ref("Произошла ошибка при обновлении информации о вас(!");
