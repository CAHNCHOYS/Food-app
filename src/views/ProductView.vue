<template>
   <div class="product-page">
      ...
      <div class="product-page__product-body">
               ...
               <div class="product__info-col">
                  ...
                  <div class="product__actions">
                     <div class="product__price">
                        <div class="product__current-price">{{ pageProduct.Price * pageProduct.count }}₽</div>
                     ...
                     <div class="product__count count-product">
                        <div class="count-product__row">
                           ...
                           <div class="count-product__number">{{ pageProduct.count }}</div>
                  ...
                  <div class="product__add-to-cart">
                     <button class="btn icon-cart" v-show="!isActionLoading" @click="addProductAction({
                  ...
                  <LoadingGif class="product__action-load" v-if="isActionLoading"></LoadingGif>

                  <Transition name="product-message">
                     <div class="product-page__message product-message_success" v-if="isProductAdded">
                        Товар добавлен в корзину!
                     </div>
                  </Transition>

                  <Transition name="product-message">
                     <div class="product-page__message  product-message_error" v-if="isAddProductError">
                        {{ actionErrorMessage }}
                     </div>
                  </Transition>
                  ...
                  <Transition name="product-message">
                     <div class="product-page__message  product-message_error" v-if="isNotLoggedUser">
         ...
         <VErrorMessage style="margin-bottom: 20px" v-if="isErr" :err-message="errorMessage"></VErrorMessage>
         <p v-if="!isLoading && !pageProduct && !isErr">Не удалось найти товар с таким именем и айди, проверьте ссылку!
         </p>
...
const { isErr, isLoading, pageProduct, errorMessage } = useSingleProductFetch(props);
